  ...
  <motion.div className="relative h-[500px] md:h-auto">
  <motion.div 
  ...
  >
    {skills.map((skillGroup, index) => (
      <motion.div 
        ...
        className="skill-card group relative p-6 rounded-xl border border-slate-200 bg-white shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden"
        whileHover={{ 
          y: -3,
      ...
      >
        ...
        <motion.div 
          className="absolute inset-0 bg-gradient-to-br from-purple-50/50 to-purple-100/50 opacity-0 group-hover:opacity-50 transition-opacity duration-300 -z-10"
        />
        
        {/* Minimal dots pattern */}
        <div className="absolute inset-0 opacity-5 -z-20">
          <div className="absolute inset-0 bg-[radial-gradient(#000_0.5px,transparent_0.5px)] [background-size:12px_12px]" />
        </div>
          ...
          {skillGroup.items.map((skill, skillIndex) => (
            ...
            >
              <a 
                ...
                className="inline-block px-3 py-1 bg-white rounded-full text-sm font-medium text-slate-700 shadow-xs border border-slate-200 hover:bg-purple-50 hover:border-purple-200 hover:text-purple-600 transition-all"
              >
                {skill.name}
              </a>
            </motion.div>
